...
export default function TokensPage() {
  ...
  // Render different UI based on roles
  const renderControls = () => {
      ...
      return (
        <Card>
          <CardHeader>
            ...
            <CardDescription>Full token management</CardDescription>
          </CardHeader>
          <CardContent>
    ...
    if (isMinter) {
      return (
        <Card>
          <CardHeader>
            <CardTitle>Minter Controls</CardTitle>
            <CardDescription>Token minting operations</CardDescription>
          </CardHeader>
          <CardContent>
            {/* Minter specific controls */}
          </CardContent>
        </Card>
      )
    }
    ...
    return (
      <Card>
        <CardHeader>
          ...
          <CardDescription>View your token balance</CardDescription>
        </CardHeader>
        <CardContent>
          <div className="space-y-6">
